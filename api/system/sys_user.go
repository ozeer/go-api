...
import (
	...
	systemReq "github.com/ozeer/go-api/model/system/request"
	systemRes "github.com/ozeer/go-api/model/system/response"
...
func (b *BaseApi) Register(c *gin.Context) {
	...
	user := &system.SysUser{Username: r.Username, Password: r.Password, Phone: r.Phone, Email: r.Email}
